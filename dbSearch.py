...
from VLMEncoder.mobileclip_image_transforms import encode_image, load_image
...
def searchImg(
    input_image_path, df, model_path, encoded_images_path, dist, signal=None, tid=None
):
...
def searchText(
    input_text, df, model_path, encoded_images_path, dist, signal=None, tid=None
):
    # Select distance function for the similarity search
    dist_func = dist_dict[dist]
    # Load all images encoding
